...
1. **Navigate to the Admin Management Page**
   Access this section by clicking the help link on the top right of the Admins page.
2. **Enter Admin Details**Fill in the following information:

   - **Full Name**: The admin's full legal name.
...
4. **Assign Permission Group**
   After creation, you will see an overview of the new admin. Assign the appropriate permission group to control what sections and actions the admin can access.

   ![Admin Overview](https://s3.amazonaws.com/helpscout.net/docs/assets/5b4c4e430428631d7a88ed10/images/5b4c4fb92c7d3a03f89c97ab/img-28331-1531727782-1673077096.png)
